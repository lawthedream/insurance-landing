...
const ExpertSectionTraffic: React.FC = () => {
    ...
    return (
        <section id="our-team" className="relative py-24 bg-white overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: 'url("/intro_img3.jpg")',
            ...
            <ScrollReveal>
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="text-center mb-16">
                        <span className="inline-block py-1 px-3 rounded bg-[#F4F7F9] text-[#333333] text-sm font-bold tracking-widest mb-4">
                            OUR TEAM
                        </span>
                        <h2 className="text-3xl md:text-5xl font-black text-[#333333]">
                            결과를 바꾸는 더드림의 <span className="text-[#3182A4]">드림팀</span>을 소개합니다.
                        </h2>
                    </div>

                    {/* Expert Carousel - Fixed Height */}
                    <div className="max-w-5xl mx-auto mb-24 relative">
                        <div className="bg-[#F4F7F9] rounded-3xl overflow-hidden shadow-lg border border-slate-100 flex flex-col md:flex-row h-[750px] md:h-[650px]">
                            ...
                            <div className="md:w-7/12 p-6 md:p-12 flex flex-col justify-center relative md:h-full h-auto shrink-0 md:shrink">
                                <div className="mb-8 hidden md:block">
                                    <p className="text-[#3182A4] font-bold mb-1 text-sm">{currentExpert.role}</p>
                                ...
                                <div className="mb-6 md:mb-8 flex-1 flex flex-col justify-start md:justify-center">
                                    <Quote className="w-8 h-8 md:w-10 md:h-10 text-slate-200 mb-3 md:mb-4 fill-current" />
                                ...
                                <ul className="space-y-2 md:space-y-3 mb-8">
                                    {currentExpert.careers.map((career, idx) => (
                                        <li key={idx} className="flex items-start gap-3 text-slate-600">
                                            <div className="w-1.5 h-1.5 rounded-full bg-[#3182A4] mt-2.5 flex-shrink-0"></div>
                                ...
                                <div className="flex items-center gap-2 md:gap-4 mt-auto pt-6 border-t border-slate-200 w-full justify-between md:justify-start">
                                    <button
                                        onClick={prevSlide}
                                        className="p-3 rounded-full border border-slate-300 hover:bg-white hover:border-[#3182A4] hover:text-[#3182A4] transition-all flex-shrink-0"
                                    >
                                    ...
                                    <div className="flex gap-2">
                                        {experts.map((_, idx) => (
                                            <button
                                                ...
                                                className={`w-2.5 h-2.5 rounded-full transition-all flex-shrink-0 ${idx === activeIndex ? "bg-[#3182A4] w-8" : "bg-slate-300"
                                                    }`}
                                            />
                                        ))}
                                    </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <h3 className="text-2xl font-bold text-[#333333]">
                                변하지 않는 더드림의 <span className="text-[#3182A4]">세 가지 약속</span>
                            </h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                <div className="w-12 h-12 bg-[#F4F7F9] text-[#3182A4] rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#1B3B5A] group-hover:text-white transition-colors">
                                    <UserCheck className="w-6 h-6" />
                                </div>
                                <h4 className="text-lg font-bold text-[#333333] mb-3">
                                    <span className="text-[#3182A4] text-sm block mb-1">원칙 1</span>
                                    교통사고 전문 손해사정사가<br />초기 상담을 진행합니다.
                                </h4>
                                <p className="text-slate-500 text-sm leading-relaxed">
                                    전문성 없는 보조인이나 사무장 대신,
                                    보험사출신 교통사고 전문 손해사정사가 <strong>상담 및 사건을 직접</strong> 진행합니다.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                ...
                                <h4 className="text-lg font-bold text-[#333333] mb-3">
                                    <span className="text-[#3182A4] text-sm block mb-1">원칙 2</span>
                                    착수금 없이<br />상담을 진행합니다.
                                </h4>
                                <p className="text-slate-500 text-sm leading-relaxed">
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                ...
                                <h4 className="text-lg font-bold text-[#333333] mb-3">
                                    <span className="text-[#3182A4] text-sm block mb-1">원칙 3</span>
                        ...
                        <div className="text-center mt-12">
                            <a
                                href="#contact-form"
                                className="inline-flex items-center justify-center bg-[#1B3B5A] hover:bg-[#152e46] text-white px-6 md:px-8 py-5 rounded-xl font-bold text-base md:text-xl transition-all shadow-[0_0_20px_rgba(27,59,90,0.5)] hover:shadow-[0_0_30px_rgba(27,59,90,0.7)] transform hover:-translate-y-1 whitespace-nowrap"
                            >
                                전문가에게 내 사건 상담하기
                            </a>
                        </div>
...
export default ExpertSectionTraffic;
