    ...
    return (
        <section id="brand-story" className="py-32 bg-[#F9F9F7] overflow-hidden">
            <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
                        <div className="max-w-2xl">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-[#2D2D2D] leading-[1.1] tracking-tight">
                                더드림은 <span className="text-[#C77E1E]">한 사람의 고민</span>에서<br /> 시작되었습니다.
                            </h2>
                        </div>
                    </div>
                </ScrollReveal>
                ...
                <ScrollReveal>
                    <div className="mt-24 md:mt-32 p-12 md:p-20 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-[#2D2D2D]/5 text-center relative overflow-hidden group">
                        <div className="absolute top-0 left-0 w-40 h-40 bg-[#C77E1E]/5 rounded-br-full -translate-x-1/2 -translate-y-1/2 transition-transform group-hover:scale-110"></div>

                        <p className="text-base md:text-lg text-slate-500 mb-8 font-medium">
                            더드림은 사업을 위해 모인 팀이 아닙니다.
                        </p>
                        <h3 className="text-xl md:text-3xl font-black text-[#2D2D2D] leading-tight break-keep">
                            같은 문제를 <span className="text-[#C77E1E] relative">
                                오래 고민한 사람들
                                <span className="absolute bottom-1 left-0 w-full h-2 md:h-3 bg-[#C77E1E]/20 -z-10 rounded-full"></span>
                            </span>이,<br />
                            고객의 불편을 <span className="text-[#C77E1E] relative">
                                직접 해결하기 위해
                                <span className="absolute bottom-1 left-0 w-full h-2 md:h-3 bg-[#C77E1E]/20 -z-10 rounded-full"></span>
                            </span> 모인 팀입니다.
                        </h3>
