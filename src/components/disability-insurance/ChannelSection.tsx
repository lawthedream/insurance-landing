...
const ChannelSection: React.FC = () => {
    ...
    return (
        <section id="channel" className="py-24 bg-[#F9F9F7] relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute top-0 left-0 w-96 h-96 bg-[#2D2D2D]/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
                ...
                <ScrollReveal>
                    <div className="text-center mb-10 md:mb-16">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-[#333333] mb-6">
                            상해후유장해, <span className="text-[#C77E1E]">알수록 유리합니다.</span>
                        </h2>
                ...
                <div className="max-w-5xl mx-auto relative group">
                    ...
                    <ScrollReveal>
                        ...
                        <div className="md:hidden mt-4 text-center px-2 min-h-[3rem] flex items-center justify-center">
                            <p className="text-[#2D2D2D] text-lg font-bold leading-tight break-keep">
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/90 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-[#2D2D2D] hover:bg-[#2D2D2D] hover:text-white transition-all z-20 opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0"
                    >
                        <ChevronLeft className="w-6 h-6" />
                    </button>
                    <button
                        onClick={nextSlide}
                        className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/90 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-[#2D2D2D] hover:bg-[#2D2D2D] hover:text-white transition-all z-20 opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0"
                    >
                    ...
                    <div className="flex justify-center gap-3 mt-8">
                        {videos.map((_, idx) => (
                            <button
                                ...
                                className={`h-2 rounded-full transition-all ${idx === activeIndex ? "bg-[#2D2D2D] w-8" : "bg-slate-300 w-2"
                                    }`}
                            />
                        ))}
                    </div>
                ...
                <ScrollReveal>
                    <div className="text-center mt-12">
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-[#2D2D2D] text-[#C77E1E] px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#1a2533] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                        >
                            유튜브 채널 바로가기
