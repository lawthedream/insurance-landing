        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[#333333]">
              더드림을 선택한 분들이 <span className="text-[#2C3E50] border-b-4 border-[#EDC967]/30">직접 전하는 이야기</span>
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden flex flex-col md:flex-row h-[750px] md:h-[500px]">
              <div className="md:w-2/5 bg-slate-100 relative flex-1 min-h-0 md:h-full">
                ...
                <div className="absolute bottom-6 left-6 text-white z-10">
                  <div className="flex items-center gap-1 mb-2">
                    {[1, 2, 3, 4, 5].map(i => <Star key={i} className="w-4 h-4 fill-[#EDC967] text-[#EDC967]" />)}
                  </div>
              ...
              <div className="md:w-3/5 p-6 md:p-12 flex flex-col justify-center bg-white relative h-auto md:h-full shrink-0 md:shrink">
                {/* Decoration */}
                <Quote className="w-10 h-10 md:w-12 md:h-12 text-[#2C3E50]/10 fill-current mb-4 md:mb-6 absolute top-6 right-6 md:static flex-shrink-0" />
                  ...
                  <div className="flex gap-2">
                    {testimonials.map((_, idx) => (
                      <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all ${idx === activeIndex ? 'bg-[#2C3E50] w-6' : 'bg-slate-300'}`}
                      />
                    ))}
                  </div>
          ...
          <div className="text-center mt-12">
            <a
              href="#contact-form"
              className="inline-flex items-center justify-center bg-[#2C3E50] hover:bg-[#1a2530] text-white px-6 md:px-10 py-5 rounded-xl font-bold text-base md:text-xl transition-all shadow-[0_0_20px_rgba(44,62,80,0.5)] hover:shadow-[0_0_30px_rgba(44,62,80,0.7)] transform hover:-translate-y-1 whitespace-nowrap"
            >
              내 사고 상담 신청하기
            </a>
          </div>
