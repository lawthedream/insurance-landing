...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#2C3E50] text-slate-400 py-16 border-t border-[#1a2530]">
          ...
          <div className="lg:w-2/3 flex flex-wrap gap-12">
            <div>
              ...
              <ul className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-3 text-sm">
                <li><a href="https://www.lawthedream.com/" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDC967] transition-colors font-bold">더드림법률사무소 메인</a></li>
                <li><a href="https://www.lawthedream.com/new2019/" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDC967] transition-colors">산재/보험보상 센터</a></li>
                <li><a href="https://www.lawthedream.com/law/" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDC967] transition-colors">교통형사 센터</a></li>
                <li><a href="http://labordream.com/work/index.php" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDC967] transition-colors">직업병 연구원</a></li>
                <li><a href="https://www.lawthedream.com/center/" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDC967] transition-colors">보험분쟁 센터</a></li>
                <li><a href="https://www.lawthedream.com/accident/" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDC967] transition-colors">중대재해 센터</a></li>
              </ul>
            </div>
            ...
            <div className="w-full md:w-auto">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://www.youtube.com/@the_Dream_Traffic" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#152e46] rounded-full flex items-center justify-center hover:bg-red-600 hover:text-white transition-all">
                  <Youtube className="w-5 h-5" />
                </a>
                <a href="https://cafe.naver.com/thedreamlaw" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#152e46] rounded-full flex items-center justify-center hover:bg-[#EDC967] hover:text-[#2C3E50] transition-all">
